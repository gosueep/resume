...
\begin{center}
    ...
    \small
    \href{https://linkedin.com/in/epahk}{\faLinkedin\ epahk}  $|$
    \href{mailto:eugin03@gmail.com}{\faEnvelope\ eugin03@gmail.com} $|$
    % \raisebox{-0.1\height} 
    \href{tel:7192713078}{\faPhone\ (719) 271-3078} $|$ 
    % \vspace{2pt}
    \href{https://github.com/gosueep}{\faGithub\ gosueep}
    \vspace{-5pt}
\end{center}
...
\section{Education}   %-----------EDUCATION-----------
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Colorado Scholars Fund, Google C-MAPP Scholar, PATHS CS Scholar, Outstanding Graduating Senior}
...
\section{Skills and Certifications}   %-----------Technical Skills-----------
 \begin{itemize}[leftmargin=0.1in, label={}]
    \small{\item{
      \textbf{Active Secret Clearance ; Certifications} - AWS Solutions Architect -- Associate, Security Pro, Network Pro \\
      \textbf{Skills/Tools}{: Python, Go, Java, C++, JS, C\#, AWS, NodeJS, React, Maven, Jenkins, SonarQube} \\
...
\section{Work Experience}   %-----------Work EXPERIENCE-----------
  \resumeSubHeadingListStart
    % Spectrum
    \resumeSubheading
      {Spectrum}{Aug. 2024 -- Present}
      {Software Engineer III}{Denver, CO}
      \resumeItemListStart
        \resumeItem{Developing a modernized  JUnit test framework for PINXT, the central gateway for all of Spectrum's traffic}
      \resumeItemListEnd
    ...
    \resumeItemListStart
      ...
      % \resumeItem{Discrete Math - fundamentals of computer science including logic, sets, proofs, combinatorics, and recursion}
      % \resumeItem{Programming Challenges - technical interview topics such as dynamic programming, string processing, multithreading}
      % \resumeItem{Intro to Cryptography - basic cryptography concepts ranging from encryption to computational number theory}
    \resumeItemListEnd

    % % Discrete Math
    % \resumeSubheading
    % {Colorado School of Mines}{Jan. 2022 -- May 2022}
    % {Discrete Math (CSCI 358) Teaching Assistant}{Golden, CO}
    % \resumeItemListStart
    %   \resumeItem{Taught fundamentals of computer science including logic, sets, proofs, combinatorics, and recursion}
    %   \resumeItem{Wrote homework assignments \& exams, graded, and held weekly office hours for 150 students across 3 sections}
    % \resumeItemListEnd

    % % Programming Challenges
    % \resumeSubheading
    % {Colorado School of Mines}{Aug. 2022 -- Dec. 2022}
    % {Programming Challenges Teaching Assistant}{Golden, CO}
    % \resumeItemListStart
    %   \resumeItem{Guided students through programming challenges and aided in debugging their code on topics such as dynamic programming, string processing, multithreading}
    % \resumeItemListEnd
...
\section{Research Experience}   %-----------Work EXPERIENCE-----------
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Research Assistant, 2nd Author (ACM CHI 2023)}{Golden, CO}
      \resumeItemListStart
        ...
        \resumeItem{\href{https://doi.org/10.1145/3544548.3581360}{\textit{Exploring the Negotiation Behaviors of Owners and Bystanders over Data Practices of Smart Home Devices}}}
    \resumeItemListEnd
  \resumeSubHeadingListEnd
...
\section{Leadership Experience \& Clubs}  %-----------Work EXPERIENCE-----------
  \resumeSubHeadingListStart
    % ACM
    \resumeSubheading
      {Association for Computing Machinery (ACM)}{Aug. 2021 -- Dec 2023}
      {Vice Chair, Student Advisor}{Golden, CO}
      \resumeItemListStart
        \resumeItem{Led club \& officers, planned weekly meetings \& events, arranged tech talks with industry partners}
        \resumeItem{Organized travel to a hackathon at University of North Carolina Chapel Hill for 16 local chapter members}
        \resumeItem{Facilitated a mentorship program in collaboration with ACM-W to connect underclassmen with upperclassmen}
      \resumeItemListEnd

    % Oresec
    \resumeSubheading
      {Mines Cybersecurity Club (Oresec) }{Aug. 2021 -- Dec. 2023}
      {Secretary}{Golden, CO}
      \resumeItemListStart
        \resumeItem{Coordinated tech talks from alumni and industry professionals}
        \resumeItem{Competed in CTFs, blue-team defense competitions; 3rd at Rocky Mountain Collegiate Cyber Defense Competition (RMCCDC), 8th at DoE CyberForce, 5th place finalist at NYU's Embedded Security Challenge}
      \resumeItemListEnd
