...
\section{Education}   %-----------EDUCATION-----------
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Colorado Scholars Fund (full-tuition scholarship), Google C-MAPP Scholar, PATHS CS Scholar, FIRST Scholar}
...
\section{Work Experience}   %-----------Work EXPERIENCE-----------
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Developing custom CRM software to organize AWS sales opportunities and projects for small companies}
...
\section{Projects}    %-----------PROJECTS-----------
    \resumeSubHeadingListStart
      ...
      {Rende $|$ \href{https://rende.fun}{https://rende.fun}}{Jan. 2023 -- Present}
        \resumeItemListStart
